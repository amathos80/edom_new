using eDom.Application.Features.Assistiti;
...
[Authorize]
public class AssistitiController(IMediator mediator) : ControllerBase
{
    [HttpGet]
    public async Task<IActionResult> Search([FromQuery] GetAssistitiEPazientiQuery query, CancellationToken ct)
    {
