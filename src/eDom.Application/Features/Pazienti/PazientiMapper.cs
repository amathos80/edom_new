...
public partial class PazientiMapper
{
    ...
    [MapperIgnoreTarget(nameof(Paziente.ComuneReperibilitaId))]
    [MapperIgnoreTarget(nameof(Paziente.CapReperibilita))]
    [MapperIgnoreTarget(nameof(Paziente.IndirizzoReperibilita))]
    [MapperIgnoreTarget(nameof(Paziente.NomeCampanelloReperibilita))]
    [MapperIgnoreTarget(nameof(Paziente.AreaReperibilitaId))]
